...
4- Definir rangos de filas y grupos correspondientes
...
6- Crear el objeto phylo.to.map
...
7- Definir colores para cada grupo
...
8- Obtener los colores para cada especie dentro de los grupos
...
9- Asigna colores basándote en los rangos
...
10- Asegura que cualquier posición no asignada obtenga un color predeterminado (puedes ajustar según necesites)
...
11- Crea un vector de colores asignados a las puntas del árbol
...
Opcional- Colorear y mostrar el mapa (opcion arcoiris)
